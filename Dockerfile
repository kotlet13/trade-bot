...
ENV RUNTIME_TELEMETRY_ENABLED=true
ENV RUNTIME_TELEMETRY_INTERVAL_SECONDS=900
ENV RUNTIME_TELEMETRY_CANDLE_LIMIT=240
ENV RUNTIME_TELEMETRY_FUTURES_ENABLED=true
ENV RUNTIME_TELEMETRY_SIGNAL_EVALUATIONS=true
